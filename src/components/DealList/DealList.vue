...
import { selectItems, removeItem, fetchItems } from '@/store/deals/selectors';
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      onClickEdit: id => {
        router.push({ name: 'DealEdit', params: { id } })
      }
    }
  }
